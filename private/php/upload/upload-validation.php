...
class UploadValidation
{
	...
	private function validateFileSize($index)
	{
		...
		{
			$this->validResult['errors']['perFile'][$index] = "Plik nie został przesłany.<br/>Błąd: Plik jest zbyt duży. Maksymalny rozmiar pliku to " . ( $accountInfo['max_file_size'] / GB ) . "GB";
		}
	}
}
?>